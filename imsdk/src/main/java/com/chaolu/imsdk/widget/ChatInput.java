package com.chaolu.imsdk.widget;
...
import com.chaolu.imsdk.util.SViewUtil;
...
public class ChatInput extends RelativeLayout implements TextWatcher, View.OnClickListener {
    ...
    private boolean isSendVisible, isHoldVoiceBtn, isEmoticonReady, isCancelVoiceBtn;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        isHoldVoiceBtn = true;
                        updateVoiceView();
                        LogUtil.e("voicePanel:ACTION_DOWN");
                        break;
                    case MotionEvent.ACTION_UP:
                        isHoldVoiceBtn = false;
                        updateVoiceView();
                        LogUtil.e("voicePanel:ACTION_UP");
                        break;
                    case MotionEvent.ACTION_MOVE:
                        if (SViewUtil.isViewUnder(voiceSendingView, event, null)) {
                            isCancelVoiceBtn = true;
                            LogUtil.e("voicePanel:ACTION_MOVE:true");
                        } else {
                            isCancelVoiceBtn = false;
                            LogUtil.e("voicePanel:ACTION_MOVE:false");
                        }
                        break;
                }
                return true;
    ...
    private void updateVoiceView() {
        if (isHoldVoiceBtn) {
            ...
            if (isCancelVoiceBtn) {
                //取消发送语音消息
                LogUtil.e("updateVoiceView:cancelSendVoice");
                chatView.cancelSendVoice();
                isCancelVoiceBtn = false;
            } else {
                //发送语音消息
                LogUtil.e("updateVoiceView:endSendVoice");
