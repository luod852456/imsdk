...
public class ActivityManager
{
    ...
    private final Application.ActivityLifecycleCallbacks mActivityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks()
    {
        ...
        public void onActivityResumed(Activity activity)
        {
            ...
            {
                if (mIsDebug)
                    Log.e(ActivityManager.class.getSimpleName(), "start order activity " + activity + " old index " + index);

                removeActivity(activity);
                addActivity(activity);

                if (mIsDebug)
                    Log.e(ActivityManager.class.getSimpleName(), "end order activity " + activity + " new index " + mActivityHolder.indexOf(activity));
            }
        }
    ...
    private void addActivity(Activity activity)
    {
        ...
        if (mIsDebug)
            Log.i(ActivityManager.class.getSimpleName(), "+++++ " + activity + "\n" + getCurrentStack());
    }
    ...
    private void removeActivity(Activity activity)
    {
        ...
        {
            if (mIsDebug)
                Log.e(ActivityManager.class.getSimpleName(), "----- " + activity + "\n" + getCurrentStack());
        }
    }
    ...
    /**
     * 返回指定的Activity，否则返回最后一个Activity
     *
     * @param clazz
     * @return
     */
