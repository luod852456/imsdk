...
import com.chaolu.imsdk.ui.AddFriendActivity;
import com.chaolu.imsdk.ui.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public String getGroupName(){
        ...
        if (profile.getFriendGroups().size() == 0){
            return ImSdkLibrary.getInstance().getContext().getString(R.string.default_group_name);
        }else{
