...
//        context.startActivity(intent);
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_me)+
                            ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_invite)+
                                ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_me)+
                                ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_me)+
                            ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+ImSdkLibrary.getInstance().getContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return ImSdkLibrary.getInstance().getContext().getString(R.string.conversation_system_group);
    }
