...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(ImSdkLibrary.getInstance().getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(ImSdkLibrary.getInstance().getContext());
        ...
        TextView tv = new TextView(ImSdkLibrary.getInstance().getContext());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(ImSdkLibrary.getInstance().getContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return ImSdkLibrary.getInstance().getContext().getString(R.string.summary_voice);
    }
