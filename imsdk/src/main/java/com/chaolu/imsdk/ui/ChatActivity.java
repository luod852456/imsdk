...
import com.chaolu.imsdk.mvp.presenter.ChatPresenter;
import com.chaolu.imsdk.util.FileUtil;
import com.chaolu.imsdk.util.MediaUtil;
import com.chaolu.imsdk.util.RecorderUtil;
import com.chaolu.imsdk.mvp.view.ChatView;
import com.chaolu.imsdk.widget.ChatInput;
import com.chaolu.imsdk.widget.TemplateTitle;
import com.chaolu.imsdk.widget.VoiceSendingView;
...
import com.chaolu.imsdk.mvp.model.FileMessage;
import com.chaolu.imsdk.mvp.model.ImageMessage;
import com.chaolu.imsdk.mvp.model.Message;
import com.chaolu.imsdk.mvp.model.MessageFactory;
import com.chaolu.imsdk.mvp.model.TextMessage;
import com.chaolu.imsdk.mvp.model.VoiceMessage;
...
public class ChatActivity extends FragmentActivity implements ChatView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ChatAdapter(this, R.layout.item_chat_message, messageList);
        ...
        input.setVoiceSendingView(voiceSendingView);
        presenter.start();
    }
...
//        presenter.sendMessage(message.getMessage());
    ...
    public void cancelSendVoice() {
        ...
        voiceSendingView.setVisibility(View.GONE);
        recorder.stopRecording();
        Toast.makeText(getBaseContext(),"取消发送语音消息",Toast.LENGTH_LONG);
    }
