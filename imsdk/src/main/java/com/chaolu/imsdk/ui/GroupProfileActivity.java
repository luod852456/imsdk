...
import com.chaolu.imsdk.mvp.model.UserInfo;
import com.chaolu.imsdk.mvp.presenter.GroupInfoPresenter;
import com.chaolu.imsdk.mvp.presenter.GroupManagerPresenter;
import com.chaolu.imsdk.mvp.view.GroupInfoView;
import com.chaolu.imsdk.widget.LineControllerView;
import com.chaolu.imsdk.widget.ListPickerDialog;
...
public class GroupProfileActivity extends AppCompatActivity implements GroupInfoView, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btnChat) {
            ...
            new ListPickerDialog().show(messageOptList, getFragmentManager(), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, final int which) {
