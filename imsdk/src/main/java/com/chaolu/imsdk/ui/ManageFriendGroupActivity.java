...
import com.chaolu.imsdk.adapter.GroupListAdapter;
...
public class ManageFriendGroupActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_friend_group);
    ...
    private void addDialog() {
        addGroupDialog = new Dialog(this, R.style.dialog_imsdk);
