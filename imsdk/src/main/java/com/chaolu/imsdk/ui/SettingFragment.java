...
import com.chaolu.imsdk.mvp.view.FriendInfoView;
        ...
        if (view == null) {
            ...
            logout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ImSdkManager.getInstance().logout(new TIMCallBack() {
                        @Override
            ...
            initLineControllerView(view);

        }
        return view;
    }

    private void initLineControllerView(View view) {
        nickName = (LineControllerView) view.findViewById(R.id.nickName);
        nickName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditActivity.navToEdit(SettingFragment.this,
                        getResources().getString(R.string.setting_nick_name_change),
                        name.getText().toString(),
                        REQ_CHANGE_NICK,
                        new EditActivity.EditInterface() {
                            @Override
