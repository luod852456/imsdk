...
import com.chaolu.imsdk.mvp.model.GroupMemberProfile;
...
public class GroupMemberProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (canManage()){
            ...
            setQuiet.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new ListPickerDialog().show(getQuietOption(), getFragmentManager(), new DialogInterface.OnClickListener() {
                        @Override
