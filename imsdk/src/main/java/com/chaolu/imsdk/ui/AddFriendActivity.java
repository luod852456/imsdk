...
import com.chaolu.imsdk.mvp.view.FriendshipManageView;
 ...
 * 申请添加好友界面
 */
public class AddFriendActivity extends AppCompatActivity implements View.OnClickListener, FriendshipManageView {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnAdd) {
            ...
            new ListPickerDialog().show(groups, getFragmentManager(), new DialogInterface.OnClickListener() {
                @Override
